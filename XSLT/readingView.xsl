        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                ...
                <div id="mainContainer">
                    ...
                    <div class="content">
                        <label class="container">Personal Attack <input type="checkbox"
                                checked="checked"/>
                            <span class="checkmark"/><br/>
                        </label>
                        <label class="container">Name Calling <input type="checkbox"
                                checked="checked"/>
                            <span class="checkmark"/><br/>
                        </label>
                    ...
                    <div class="content">
                        <label class="container">Male to male <input type="checkbox"
                                checked="checked"/>
                            <span class="checkmark"/><br/>
                        </label>
                        <label class="container">Male to female <input type="checkbox"
                                checked="checked"/>
                            <span class="checkmark"/><br/>
                        </label>
                        <label class="container">Female to female <input type="checkbox"
                                checked="checked"/>
                            <span class="checkmark"/><br/>
                        </label>
                        <label class="container">Female to male <input type="checkbox"
                                checked="checked"/>
                            <span class="checkmark"/><br/>
                        </label>
                    </div>
                    ...
                    <div class="content">
                        <label class="container">Parent to child <input type="checkbox"
                                checked="checked"/>
                            <span class="checkmark"/><br/>
                        </label>
                        <label class="container">Child to parent <input type="checkbox"
                                checked="checked"/>
                            <span class="checkmark"/><br/>
                        </label>
                        <label class="container">Sibling to sibling <input type="checkbox"
                                checked="checked"/>
                            <span class="checkmark"/><br/>
                        </label>
                        <label class="container">Friend to friend <input type="checkbox"
                                checked="checked"/>
                            <span class="checkmark"/><br/>
                        </label>
                        <label class="container">Couple to couple <input type="checkbox"
                                checked="checked"/>
                            <span class="checkmark"/><br/>
                        </label>
                    ...
                    <!-- Start of collapsible -->
                    <button type="button" class="collapsible">Speech Act</button>
                    <!-- This portion needs to be renamed and new CSS elements created -->
                    <div class="content">
                        ...
                        <div class="content">
                            ...
                            <div class="content">
                                <label class="container">Quality <input type="checkbox"
                                        checked="checked"/>
                                    <span class="checkmark"/><br/>
                                </label>
                                <label class="container">Quantity <input type="checkbox"
                                        checked="checked"/>
                                    <span class="checkmark"/><br/>
                                </label>
                                <label class="container">Relevance <input type="checkbox"
                                        checked="checked"/>
                                    <span class="checkmark"/><br/>
                                </label>
                                <label class="container">Manner <input type="checkbox"
                                        checked="checked"/>
                                    <span class="checkmark"/><br/>
                                </label>
                            </div>
                            ...
                            <div class="content">
                                ...
                                <label class="container">Directive <input type="checkbox"
                                        checked="checked"/>
                                    <span class="checkmark"/><br/>
                                </label>
                                <label class="container">Commissive <input type="checkbox"
                                        checked="checked"/>
                                    <span class="checkmark"/><br/>
                                </label>
                                <label class="container">Expressive <input type="checkbox"
                                        checked="checked"/>
                                    <span class="checkmark"/><br/>
                                </label>
